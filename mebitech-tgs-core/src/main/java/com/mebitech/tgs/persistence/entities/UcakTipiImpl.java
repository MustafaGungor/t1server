...
@Entity
@Table(name = "UCAK_TIPI")
public class UcakTipiImpl implements IUcakTipi {
    @Id
    @GeneratedValue
    ...
    public UcakTipiImpl(Long id, Date createDate, Boolean deleted
    ...
    public UcakTipiImpl(IUcakTipi ucakTipi) {
        this.deleted = ucakTipi.getDeleted();
        this.id = ucakTipi.getId();
        this.createDate = ucakTipi.getCreateDate();
        this.kodu = ucakTipi.getKodu();
        this.adi = ucakTipi.getAdi();
    }
